  ...
  fields: [
    {
      ...
      defaultValue: "none",
      options: [
        { label: { en: "Not connected", ar: "غير مربوط" }, value: "none" },
    ...
    { name: "ga4PropertyId", type: "text", admin: { description: { en: "For pulling GA4 Data API reports to display in the dashboard.", ar: "لسحب تقارير GA4 Data API لعرضها في اللوحة." }, condition: (data) => data?.provider === "ga4" } },
