...
export const SiteSettings: GlobalConfig = {
  ...
  fields: [
    { name: "nameAr", type: "text", required: true, defaultValue: "شركة اجتياز الخليج للمقاولات" },
    {
      ...
      admin: { description: { en: "TODO_VERIFY: the approved English legal name has not been confirmed yet.", ar: "TODO_VERIFY: الاسم القانوني الإنجليزي المعتمد لم يُؤكَّد بعد." } },
    },
    { name: "nameEnStatus", type: "select", defaultValue: "pending", options: [{ label: { en: "Pending verification", ar: "قيد التوثيق" }, value: "pending" }, { label: { en: "Confirmed", ar: "مؤكَّد" }, value: "confirmed" }] },
