...
export const Insights: CollectionConfig = {
  ...
  fields: [
    ...
    { name: "cover", type: "upload", relationTo: "media" },
    {
      ...
      type: "select",
      options: [
        { label: { en: "Maintenance & operations", ar: "صيانة وتشغيل" }, value: "maintenance" },
        { label: { en: "Facility management", ar: "إدارة مرافق" }, value: "facility-management" },
        { label: { en: "Quality & Safety", ar: "الجودة والسلامة" }, value: "quality-safety" },
        { label: { en: "Buyer's guide", ar: "دليل الشراء" }, value: "buyers-guide" },
      ],
    },
